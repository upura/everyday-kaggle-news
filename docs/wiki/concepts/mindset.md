...
コンペとの向き合い方、学び方、実務との関係についての話題のページです。
技術そのものではなく、続け方と活かし方に関する知見を集めています。
...
- [Kaggleで成長するために意識したこと](https://speakerdeck.com/prgckwb/kaggledecheng-chang-surutameniyi-shi-sitakoto): Master に至るまでの取り組み方の変化を語る資料。目的が LB スコアの最大化にすり替わる、高スコアの公開ノートブックをそのまま提出する、AI に答えだけを聞く、という初心者期の落とし穴を挙げている。
- [Kaggler流のプロダクト開発入門！](https://zenn.dev/elith/articles/609498a4109ad2): タスク理解・検証戦略・ベースライン・改善という Kaggle の 4 段階をプロダクト開発の課題定義・成功指標の設計・最小機能の完成・オフラインとオンラインの評価比較に読み替えた記事。生成 AI セキュリティ製品の開発を例に説明している。
...
- [入門者・初学者向けガイド](../../quickstart.md) / [称号振り返り・インタビュー](../../milestones.md) / [サービス・ツール](../../service.md)
