...
- モデルを学習させた「その後」に何をするか（分析、改善、共有）が成長の分かれ目
- コンペと開発実務は似て非なるもの。差分を意識すると、コンペの経験を実務に翻訳しやすい
- 世界トップレベルの Kaggler も長期の積み重ね（10,000 時間）を語っており、短期の成果に一喜一憂しない姿勢が大切
- 称号を目指す道のりの実例は[称号振り返り・インタビュー](../../milestones.md)に多数ある
