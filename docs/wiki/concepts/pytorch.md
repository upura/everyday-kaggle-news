...
- [PyTorch公式「Performance Tuning Guide」の検証記事](https://mattari-benkyo-note.com/2021/04/27/pytorch-performance-tuning-guide-1-parameter-grad-none/): `parameter.grad = None` の効果などを検証する連載第 1 弾。
...
- [PyTorchでGPUの計算時間を計測する方法の紹介記事](https://mattari-benkyo-note.com/2021/03/21/pytorch-cuda-time-measurement/): 単純な time() 使用時の問題点も指摘。
...
- [3次元モデルを扱うライブラリ「PyTorch3D」公開（Facebook AI）](https://ai.meta.com/blog/-introducing-pytorch3d-an-open-source-library-for-3d-deep-learning/): 短編動画でライブラリの特徴を紹介。
