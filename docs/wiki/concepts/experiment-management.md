...
- チーム戦では GitHub Issue で実験や知見を管理し、重複を防いで試行回数を最大化する体制が有効（[分析コンペをチームで戦うための技術](https://www.takapy.work/entry/2020/12/22/225715)）。個人開発でも「1実験1スクリプト」のような明快なコード管理方針が繰り返し推奨される
...
- [HydraとMLflowでパラメータ・実験管理を行う記事](https://ymym3412.hatenablog.com/entry/2020/02/09/034644): Livedoor ニュースコーパスのテキスト分類を題材にした管理方法の紹介。
