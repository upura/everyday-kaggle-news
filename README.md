...
- 2026-07-11: 目次をトップページに統合。サイト内検索・[概念マップ](./docs/concept-map.md)・共通ナビゲーションを追加
- 2026-07-11: Weekly Kaggle News #303〜#324 を反映
- 2026-07-11: 概念ページ「[エージェント対戦コンペ](./docs/wiki/concepts/agent-competition.md)」を新設
- 2026-07-10: 週次の自動取り込み（GitHub Actions + PR レビュー）を開始。Weekly Kaggle News #325〜#343 を反映
