...
- 2026-08-08: Weekly Kaggle News #347 を取り込み。ROGII コンペの銀メダル解法、画像モデルの転移学習ガイド、atmaCup #21 のデータを使った ICLR 2026 ワークショップ論文、書籍『マルチモーダルモデル入門』などを追加
- 2026-07-31: 概念ページ「[コンペ形式・技術動向の変遷](./docs/wiki/concepts/competition-evolution.md)」を全体更新。Meta Kaggle のメダル対象コンペ 461 件を集計し、データ種別の年次構成を示すインタラクティブな図を追加。押さえどころに定量的な裏づけを補強
- 2026-07-17: [コンペ開催カレンダー](./docs/calendar.md)を新設。開催中のメダル対象コンペの期間を GitHub Actions が毎日取得し、タイムラインで表示
- 2026-07-16: リンク切れ検査（Issue #3）を全件再検証。ボット対策で誤判定されていた kaggle.com・medium.com 系リンク82件の分類を修正し、確実に死んでいたリンク100件超を削除
