...
1. **探索**: `docs/materials.md` の目次から関連する概念ページを特定し、`docs/wiki/queries/` と `docs/` 直下の一覧ページも Grep で探索する。既存の Query ページで回答済みならそれを提示して終了
...
5. **目次 / log 更新**: 保存した場合は `docs/materials.md` の「Q&A」一覧と `docs/wiki/log.md` に追記する: `- YYYY-MM-DD query: <質問の要約> → queries/<file>.md`
